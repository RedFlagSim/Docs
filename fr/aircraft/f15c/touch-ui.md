...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/01-function-panel.png" alt="Panneau de fonctions">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/02-mode-switch.png" alt="Sélecteur de mode">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/03-ui-element-edit.png" alt="Édition des éléments UI">
...
Pour y accéder rapidement, touchez quatre fois de suite une zone vide de l’écran. Vous pouvez également y accéder depuis le menu principal.

![Conseils d’édition des éléments UI](/assets/F-15C/TouchUI/edit_mode.png)

![Commandes MFD en mode d’édition UI](/assets/F-15C/TouchUI/edit_mode_mfd.png)
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/04-main-menu.png" alt="Menu principal">
...
- `Tactical`: Ouvre le menu tactique pour communiquer avec les forces alliées et donner des ordres aux ailiers
- `Freeze / Resume`: Active ou désactive le système de pause dynamique ; il suspend la dynamique de vol tout en laissant les autres composants fonctionner
- `Playback`: Entrer en mode relecture
- `Restart`: Redémarrer la mission en cours
- `Calibrate Gyro`: Calibrer le gyroscope
- `UI Editor`: Passer en mode d’édition des éléments UI
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/05-input-indicator.png" alt="Indicateur d'entrée">
...
- Le losange représente votre action sur les commandes.
- Le cercle représente le trim.

Lorsque vous pilotez le F-15C, le cercle de trim peut bouger même sans action manuelle sur le trim, car le PTC ajuste automatiquement le trim.
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/06-landing-gear.png" alt="Interrupteur du train d'atterrissage">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/07-flaps.png" alt="Interrupteur des volets">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/08-throttle.png" alt="Manette des gaz">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/09-throttle-mode.png" alt="Sélecteur de mode de gaz">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/10-speed-brake.png" alt="Interrupteur d'aérofrein">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/11-show-mfd.png" alt="Afficher MFD">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/12-show-tac-map.png" alt="Afficher la carte tactique">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/13-paddle-switch.png" alt="Interrupteur paddle">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/15-rudder.png" alt="Gouverne de direction">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/17-camera-menu.png" alt="Menu de changement de caméra">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/19-castle-switch.png" alt="Interrupteur castle">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/20-status-bar.png" alt="Barre d'état">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/21-chaff-flare.png" alt="Libération chaff/flare">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/22-master-arm.png" alt="Interrupteur master arm">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/23-gun-trigger.png" alt="Détente canon">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/24-weapon-select.png" alt="Sélecteur d'arme">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/27-weapon-release.png" alt="Largage arme">
...
<img class="touch-ui-control-thumb" src="/assets/F-15C/TouchUI/controls/28-auto-acquisition.png" alt="Interrupteur auto acquisition">

Commandes :

- **Toucher :** Bascule le radar entre les modes `STBY` et `LRS`.
- **Balayer vers le haut :** Fait défiler les modes d'acquisition automatique dans l'ordre suivant : `SS` → `VS` → `BST` → `LR BST` → `SS`.
- **Balayer vers le haut et maintenir :** Active le mode `FLOOD`.

Modes d'acquisition automatique :

1. **`SS` — Supersearch :** Balaie une zone de 20° × 20° dans le champ de vision du HUD selon un motif à six barres et verrouille automatiquement la première cible détectée entre 500 ft et 10 NM.
2. **`VS` — Vertical Scan :** Balaie de 5° à 55° au-dessus de la ligne de référence du fuselage sur 7,5° d'azimut, avec acquisition automatique entre 500 ft et 10 NM.
3. **`BST` — Boresight :** Recherche le long de l'axe de visée radar ; placez la cible dans le cercle directeur de 4° du HUD. Portée d'acquisition : de 500 ft à 10 NM.
